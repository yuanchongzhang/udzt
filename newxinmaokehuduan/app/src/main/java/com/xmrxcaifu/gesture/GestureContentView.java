...
public class GestureContentView extends ViewGroup {
    ...
    public GestureContentView(Context context, boolean isVerify, String passWord, GestureDrawline.GestureCallBack callBack) {
        ...
        screenDispaly2=AppUtil.getScreenDispaly2(context);
        blockWidth = screenDispaly[0]/4;
        blockWidth2 = screenDispaly2[0]/4;
...
//			image.setBackgroundResource(R.drawable.gesture_node_normal);
            image.setBackgroundResource(R.drawable.v7gesture_node_normal);
            this.addView(image);
            invalidate();
            // 第几行
            int row = i / 3;
            ...
            int col = i % 3;
            // 定义点的每个属性
//            int leftX = col * blockWidth2 + blockWidth2 / baseNum;
//            int topY = row * blockWidth2 + blockWidth2 / baseNum;
//            int rightX = col * blockWidth2 + blockWidth2 - blockWidth2 / baseNum;
//            int bottomY = row * blockWidth2 + blockWidth2 - blockWidth2 / baseNum;
