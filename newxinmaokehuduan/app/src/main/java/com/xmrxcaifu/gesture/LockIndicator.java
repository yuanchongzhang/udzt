...
//		circle_indecator   circle_normal
		patternNoraml = getResources().getDrawable(R.drawable.circle_normal);
		patternPressed = getResources().getDrawable(R.drawable.circle_indecator);
