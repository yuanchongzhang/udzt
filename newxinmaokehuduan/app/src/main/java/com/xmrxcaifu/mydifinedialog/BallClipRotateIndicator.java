...
import com.xmrxcaifu.view.DensityUtil;
...
//        float a = DensityUtil.px2dip(BallClipRotateIndicator.this, 8);


//        paint.setStrokeWidth(8);
        float b = DensityUtil.px2dip(App.application, 16);
...
//        float circleSpacing=12;
        ...
        canvas.drawArc(rectF, -45, 320, false, paint);
    }
