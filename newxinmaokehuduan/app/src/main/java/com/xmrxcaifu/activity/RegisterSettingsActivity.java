...
public class RegisterSettingsActivity extends BaseActivty2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImmersionBar.with(RegisterSettingsActivity.this)
                .statusBarDarkFont(true, 0.2f)
                .init();
        phone = getIntent().getStringExtra("phone");
        deviceId = (String) MySharePreferenceUtil.get(RegisterSettingsActivity.this, "deviceid", "");
...
//                startActivity(new Intent(RegisterSettingsActivity.this, MainActivity2.class));
                Intent intent = new Intent(RegisterSettingsActivity.this, MainActivity2.class);
...
//                EventBus.getDefault().post(3);
            ...
            case R.id.btn_next:
                if (TextUtils.isEmpty(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterSettingsActivity.this, "密码不能为空");
                } else if (TextUtils.isEmpty(editPhone.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterSettingsActivity.this, "确认密码不能为空");
                } else if (!userPhoneNum.getText().toString().equals(editPhone.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterSettingsActivity.this, "两次输入密码不一致");
                } else if (Regular.isNumeric(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterSettingsActivity.this, "密码必须为数字和字母组合");
                    ...
                    ToastUtil.showCenterToast(RegisterSettingsActivity.this, "请同意注册协议");
                } else {
                    register();
                }
...
//                            mToast.setText(registerBean.getMeta().getMessage());
                            mToast = Toast.makeText(RegisterSettingsActivity.this, registerBean.getMeta().getMessage(), Toast.LENGTH_SHORT);
...
//                            startActivity(new Intent(RegisterSettingsActivity.this, GestureEditActivity.class));
                            EventBus.getDefault().post(101);
//                            EventBus.getDefault().post(10);
//                            ToastUtil.showCenterToast(RegisterSettingsActivity.this, loginBean.getMeta().getMessage());
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "id", loginBean.getData().getId());
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "username", loginBean.getData().getUsername());
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "phone", loginBean.getData().getPhone());
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "appHeadUrl", "");
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "token", loginBean.getData().getToken());
                            MySharePreferenceUtil.put(RegisterSettingsActivity.this, "idCard", "");
                         ...
                         /*   Intent mIntent2 = new Intent(ACTION_NAME);
                            mIntent.putExtra("yaner", "发送广播，相当于在这里传送数据");
                            //mIntent2 /verIdentity
                            sendBroadcast(mIntent2);*/

                            Intent intent = new Intent(RegisterSettingsActivity.this, GestureEditActivity.class);
...
//                        Toast.makeText(RegisterSettingsActivity.this, "error", Toast.LENGTH_SHORT).show();
    ...
    public void onEventMainThread(Integer type) {
        ...
        ToastUtil.showCenterToast(RegisterSettingsActivity.this, type + "");
