...
public class ForgetShopActivity extends BaseActivty2 {
...
//                    btnLogin.setBackgroundResource(R.drawable.btn_unclick);
                    ...
                    ToastUtil.showCenterToast(ForgetShopActivity.this, "手机号不能为空");
                } else if (TextUtils.isEmpty(editPhone.getText().toString())) {
                    ToastUtil.showCenterToast(ForgetShopActivity.this, "手机验证码不能为空");
                } else {
//                    login();
                    valid();
                }
            ...
            case R.id.btn_next:
                if (!Regular.isMobileNO(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(ForgetShopActivity.this, "手机号不符合规则");

                } else if (Regular.isNumeric(textPwd.getText().toString())) {
                    ToastUtil.showCenterToast(ForgetShopActivity.this, "密码不符合规则");
                    ...
                    ToastUtil.showCenterToast(ForgetShopActivity.this, "请获取手机验证码");
                } else {
                    repass();
                }
                ...
                .execute(new StringNoDialogCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (imgCodeVavild.getMeta().isSuccess() == false) {
                            ToastUtil.showCenterToast(ForgetShopActivity.this, imgCodeVavild.getMeta().getMessage());
                            initcaptcha2();
...
//                        Log.d(s, "eeeeeeeeeeeeeeeeeeeee");
                        ...
                        if (forgetBean.getMeta().isSuccess() == false) {
                            Toast.makeText(ForgetShopActivity.this, forgetBean.getMeta().getMessage(), Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(ForgetShopActivity.this, forgetBean.getMeta().getMessage(), Toast.LENGTH_SHORT).show();
...
//                            btn_send_mes.setClickable(true);
                            ...
                            ToastUtil.showCenterToast(ForgetShopActivity.this, registerCode.getMeta().getMessage());
                            timeCount.start();
                        } else {
                            ToastUtil.showCenterToast(ForgetShopActivity.this, registerCode.getMeta().getMessage());
                        }
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        super.onError(call, response, e);
                        Toast.makeText(ForgetShopActivity.this, "请求验证码失败", Toast.LENGTH_SHORT).show();
                        Log.d(response.toString(), "333333333333");
//                        mydismissloading();
