...
public class MainActivity3 extends BaseActivty2 {
...
//        setImmersionStatus();
        ...
        ImmersionBar.with(MainActivity3.this)
        ...
        myNewLoadingDialog2 = new MyNewLoadingDialog(MainActivity3.this);
        myNewLoadingBuilder2 = new MyNewLoadingDialog.Builder(MainActivity3.this);
...
//        mWebView.addBridgeInterface(new MyJavaSctiptInterface(mWebView, this));//注册桥梁类，该类负责H5和android通信
        ...
        mWebView.registerHandler("functionOpen", new BridgeHandler() {
            ...
            @Override
            public void handler(String data, CallBackFunction function) {
                Toast.makeText(MainActivity3.this, "网页在打开你的下载文件预览", Toast.LENGTH_SHORT).show();
                pickFile();
...
//                EventBus.getDefault().post(100);
        ...
        mWebView.registerHandler("statusBlack", new BridgeHandler() {
            @Override
            public void handler(String data, CallBackFunction function) {
                StatusBarUtil.StatusBarLightMode(MainActivity3.this);
            }
        });
        ...
        mWebView.registerHandler("statusWhite", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                StatusBarUtil.StatusBarDarkMode(MainActivity3.this, a);
            }
        });
        ...
        mWebView.registerHandler("activity", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                try {
                    startActivity(new Intent(MainActivity3.this, Class.forName(data)));
    ...
    public String getdeviceId() {
        ...
        MySharePreferenceUtil.put(MainActivity3.this, "deviceid", tm.getDeviceId());
