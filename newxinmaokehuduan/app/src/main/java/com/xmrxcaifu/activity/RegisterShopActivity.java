...
public class RegisterShopActivity extends BaseActivty2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImmersionBar.with(RegisterShopActivity.this)
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_send_mes:
                if (TextUtils.isEmpty(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterShopActivity.this, "手机号不能为空");
                } else if (!Regular.isMobileNO(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterShopActivity.this, "请输入正确的手机号码");
                } else if (TextUtils.isEmpty(userImgcaptcha.getText().toString())) {
                    ToastUtil.showCenterToast(RegisterShopActivity.this, "图形验证码不能为空");
                } else {
                    valid();
            ...
            case R.id.btn_next:
                ...
                if (TextUtils.isEmpty(userPhoneNum.getText().toString())) {
                    ...
                    ToastUtil.showCenterToast(RegisterShopActivity.this, "短信验证码不能为空");
                } else if (a == 0) {
                    ToastUtil.showCenterToast(RegisterShopActivity.this, "请获取短信验证码");
                } else {
//                    valid();
...
//                        myshowloading();
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (registerValaiBean.getMeta().isSuccess() == true) {
                            ...
                            ToastUtil.showCenterToast(RegisterShopActivity.this, registerValaiBean.getMeta().getMessage());
//                            initcaptcha2();
                        }
...
//                        showLoading();
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        if (registerCode.getMeta().isSuccess() == true) {
                            ...
                            timeCount.start();
                            ToastUtil.showCenterToast(RegisterShopActivity.this, registerCode.getMeta().getMessage());
                            a = 1;
                        } else {
//                            btnNext.setEnabled(false);
//                            btnNext.setBackgroundResource(R.drawable.btn_unclick);
...
//
                            ToastUtil.showCenterToast(RegisterShopActivity.this, imgCodeVavild.getMeta().getMessage());
                            initcaptcha2();
                        } else {
                            getCode();
                        }
...
//                        startActivity(new Intent(RegisterActivity.this, RegisterSettingsActivity.class));
                        ...
                        if (registerModel.getMeta().isSuccess() == true) {
                            ToastUtil.showCenterToast(RegisterShopActivity.this, registerModel.getMeta().getMessage());
                            Intent intent = new Intent(RegisterShopActivity.this, RegisterShopSettingsActivity.class);
...
//        ZhugeSDK.getInstance().openDebug();
                            ...
                            ZhugeSDK.getInstance().init(RegisterShopActivity.this);
