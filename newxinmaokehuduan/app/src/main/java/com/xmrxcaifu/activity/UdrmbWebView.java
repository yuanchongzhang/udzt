...
public class UdrmbWebView extends BaseActivty2 {
...
//        setImmersionStatus();
        ...
        ImmersionBar.with(UdrmbWebView.this)
        ...
        myNewLoadingDialog2 = new MyNewLoadingDialog(UdrmbWebView.this);
        myNewLoadingBuilder2 = new MyNewLoadingDialog.Builder(UdrmbWebView.this);
...
//        mWebView.getSettings().setAllowFileAccess(true);
        ...
        mWebView.registerHandler("submitFromWeb", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                Toast.makeText(UdrmbWebView.this, str, Toast.LENGTH_SHORT).show();
                //回调返回给Js
...
//        mWebView.addBridgeInterface(new MyJavaSctiptInterface(mWebView, this));//注册桥梁类，该类负责H5和android通信
        ...
        mWebView.registerHandler("functionOpen", new BridgeHandler() {
            ...
            @Override
            public void handler(String data, CallBackFunction function) {
                Toast.makeText(UdrmbWebView.this, "网页在打开你的下载文件预览", Toast.LENGTH_SHORT).show();
                pickFile();
...
//                EventBus.getDefault().post(100);
        ...
        mWebView.registerHandler("statusBlack", new BridgeHandler() {
            @Override
            public void handler(String data, CallBackFunction function) {
                StatusBarUtil.StatusBarLightMode(UdrmbWebView.this);
            }
        });
        ...
        mWebView.registerHandler("statusWhite", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                ...
                StatusBarUtil.StatusBarDarkMode(UdrmbWebView.this, a);
            }
        });
        ...
        mWebView.registerHandler("activity", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                try {
                    startActivity(new Intent(UdrmbWebView.this, Class.forName(data)));
        ...
        mWebView.callHandler("toast", new Gson().toJson(user), new CallBackFunction() {
            ...
            public void onCallBack(String data) {
                ...
                Toast.makeText(UdrmbWebView.this, data, Toast.LENGTH_SHORT).show();
    ...
    public String getdeviceId() {
        ...
        MySharePreferenceUtil.put(UdrmbWebView.this, "deviceid", tm.getDeviceId());
