...
public class LoginShopActivity extends BaseActivty2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceId = (String) MySharePreferenceUtil.get(LoginShopActivity.this, "deviceid", "");
        registerBoradcastReceiver();
//        ToastUtil.showCenterToast(this,"源生登录");
        EventBus.getDefault().register(this);
//        StatusBarUtil.StatusBarLightMode(LoginActivity.this);
        ImmersionBar.with(LoginShopActivity.this)
...
//                    btnLogin.setBackgroundResource(R.drawable.btn_unclick);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.img_back:
                String shopUrl = (String) MySharePreferenceUtil.get(LoginShopActivity.this, "shopUrl", "");
                if (shopUrl.contains("giftId")) {
//                    EventBus.getDefault().post(349);
                    Intent intent = new Intent(LoginShopActivity.this, ShopActivity2.class);
                    intent.putExtra("loginshop", "fail");
                    setResult(5000, intent);
                } else {
//                    EventBus.getDefault().post(348);
//                    setResult(Result, new Intent(LoginShopActivity.this, ShopActivity2.class));
                    Intent intent = new Intent(LoginShopActivity.this, ShopActivity2.class);
                    intent.putExtra("loginshop", "fail2");
                    setResult(5000, intent);
                }
            ...
            case R.id.rl_back:
//                EventBus.getDefault().post(349);
                String shopUrl2 = (String) MySharePreferenceUtil.get(LoginShopActivity.this, "shopUrl", "");
                if (shopUrl2.contains("giftId")) {
                    Intent intent = new Intent(LoginShopActivity.this, ShopActivity2.class);
                    intent.putExtra("loginshop", "fail");
                    setResult(5000, intent);
                } else {
...
//                setResult(1000, new Intent(LoginShopActivity.this, ShopActivity2.class));
...
//                Toast.makeText(this, "登录了", Toast.LENGTH_SHORT).show();
                if (TextUtils.isEmpty(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(LoginShopActivity.this, "手机号不能为空");
//                    btnLogin.setEnabled(false);
//                    btnLogin.setBackgroundResource(R.drawable.btn_unclick);
                } else if (!Regular.isMobileNO(userPhoneNum.getText().toString())) {
                    ToastUtil.showCenterToast(LoginShopActivity.this, "手机号不符合规则");

                } else if (userPassword.getText().toString().equals("")) {
                    ToastUtil.showCenterToast(LoginShopActivity.this, "密码不能为空");
//                    btnLogin.setEnabled(false);
//                    btnLogin.setBackgroundResource(R.drawable.btn_unclick);
//                    return;
                } else if (Regular.isNumeric(userPassword.getText().toString())) {
                    ToastUtil.showCenterToast(LoginShopActivity.this, "密码必须为数字和字母组合");
                    ...
                    btnLogin.setEnabled(true);
                    btnLogin.setBackgroundResource(R.drawable.v6button);
                    if (userPhoneNum.getText().toString().equals(MySharePreferenceUtil.get(LoginShopActivity.this, "phone1", ""))) {
                        str_flag = "1";
                    } else {
                        str_flag = "0";
                    }
...
//                startActivity(new Intent(LoginShopActivity.this, RegisterShopActivity.class));
                startActivityForResult(new Intent(LoginShopActivity.this, RegisterShopActivity.class), 3000);
...
//                finish();
            ...
            case R.id.tv_forget:
                ...
                startActivity(new Intent(LoginShopActivity.this, ForgetShopActivity.class));

//                startActivityForResult(new Intent(LoginShopActivity.this, ForgetShopActivity.class), 3600);
...
//                        Log.d(s, "eeeeeeeeeeeeeeeeeeeee");
                        ...
                        MySharePreferenceUtil.put(LoginShopActivity.this, userPhoneNum.getText().toString().trim() + "phone", userPhoneNum.getText().toString().trim());
            /*     Intent mIntent1 = new Intent(ACTION_NAME);
                        ...
                        if (loginBean.getMeta().isSuccess() == false) {
                            ToastUtil.showCenterToast(LoginShopActivity.this, loginBean.getMeta().getMessage());
                        } else {


                            MySharePreferenceUtil.put(LoginShopActivity.this, "id", loginBean.getData().getId());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "username", loginBean.getData().getUsername());
//                            MySharePreferenceUtil.put(LoginActivity.this, "idCard", loginBean.getData().getIdCard());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "phone", loginBean.getData().getPhone());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "phone1", loginBean.getData().getPhone());
//                            MySharePreferenceUtil.put(LoginActivity.this, "phone2", loginBean.getData().getPhone());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "token", loginBean.getData().getToken());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "secName", loginBean.getData().getSecName());
                            MySharePreferenceUtil.put(LoginShopActivity.this, "password", userPassword.getText().toString());

                            MySharePreferenceUtil.put(LoginShopActivity.this, "token1", loginBean.getData().getToken());
//                            Toast.makeText(LoginActivity.this, MySharePreferenceUtil.get(LoginActivity.this,"appHeadUrl","") + "", Toast.LENGTH_SHORT).show();
                            String flaggesture = (String) MySharePreferenceUtil.get(LoginShopActivity.this, MySharePreferenceUtil.get(LoginShopActivity.this, "phone1", "") + "flaggesture", "");
//                            EventBus.getDefault().post(222);
//                            EventBus.getDefault().post(250);
//                            setResult(5000, new Intent(LoginShopActivity.this, ShopActivity2.class));
                            Intent intent = new Intent(LoginShopActivity.this, ShopActivity2.class);
