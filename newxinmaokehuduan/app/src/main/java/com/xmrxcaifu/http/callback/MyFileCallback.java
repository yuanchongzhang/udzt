package com.xmrxcaifu.http.callback;
...
import com.xmrxcaifu.http.convert.FileConvert;
...
public abstract class MyFileCallback extends AbsCallback<File> {
     ...
     */
    public MyFileCallback(@NonNull String destFileDir, @NonNull String destFileName) {
